  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="description" content="My name is Jean Masvi, and I'am a Frontend Engineer and this is my website" />
        <link rel="icon" href="https://www.linkedin.com/in/jean-masvi-80071134/" />
      </Head>
      ...
      <main className={styles.main}>
        ...
        <p className={styles.grid}>
          ...
          Javascript. Contrary to popular belief, Lorem Ipsum is not simply
